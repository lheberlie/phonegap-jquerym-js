    ...
    grunt.initConfig({
        ...
        clean: {
            ...
            post_source_to_build: {
                src: ["build/js/application-merge-library.js", "build/css/application-merge-styles.css"]
            },
            post_source_to_dist: {
                src: ["dist/index-generated.html", "dist/offline-generated.html"]
            }
        },
        // ---------------------------------------------------------------------
        // grunt-contrib-copy
        ...
        copy: {
            ...
            source_to_dist: {
                files: [
                    { expand: true,
                        cwd: "bower_components/jquery-mobile-bower/css",
                        src: ["images/**"], dest: "dist/css/"
                    },
                    // copy the esrijs assets required for the map
                    { expand: true,
                        cwd: "<%= pkg.esrijsDirectory %>/js/esri",
                        src: ["images/**"], dest: "dist"
                    },
                    // copy the esrijs dijit assets
                    { expand: true,
                        cwd: "<%= pkg.esrijsDirectory %>/js/esri/dijit",
                        src: ["images/**"], dest: "dist"
                    },
                    { expand: true,
                        cwd: "src/styles/css",
        ...
        concat: {
            ...
            source_to_build: {
                files: [
                    //{ src: ["src/**/*.js","!src/**/app.js"], dest: "build/js/application-merge-library.js"},
                    { src: ["!src/**/app.js",
                        /*
                    ...
                    { src: ["build/js/application-merge-library.js", "src/**/app.js"], dest: "build/js/application-library.js"},
                    { src: [
                        "bower_components/jquery-mobile-bower/css/jquery.mobile-1.4.2.css",
//                        "build/styles/**/*.css",
                        "!build/**/app.css"
                    ], dest: "build/styles/application-merge-styles.css"}
//                    { src: ["build/styles/application-merge-styles.css", "build/**/app.css"], dest: "build/styles/application-styles.css"}
                ]
            }
        },
        // ---------------------------------------------------------------------
        ...
        uglify: {
            ...
            compress_build_to_dist: {
                src: "build/js/application-library.js",
...
//                    "js/**/*.min.js"
    ...
    grunt.registerTask("dist", [
        ...
        "uglify:compress_build_to_dist",
        "cssmin:compress_build_to_dist",
